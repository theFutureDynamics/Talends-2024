        ...
        <div class="listivo-search-panel__content">
            ...
            <?php elseif ($lstSearchField->isRadioControl()) : ?>
                <div class="listivo-search-panel__list">
                    ...
                    <?php foreach ($lstSearchField->getOptions() as $lstOption) : ?>
                        <div
                                class="listivo-search-panel__item"
                                @click="mainNumberField.setValue(<?php echo htmlspecialchars(json_encode($lstOption)); ?>)"
                        >
                            <div class="listivo-search-panel__option-button-wrapper">
                                <div
                                        class="listivo-radio"
                                        :class="{'listivo-radio--active': mainNumberField.isSelected(<?php echo htmlspecialchars(json_encode($lstOption)); ?>)}"
                                ></div>
                            </div>
