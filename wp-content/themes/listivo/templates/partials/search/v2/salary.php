        ...
        >
            ...
            >
                <div
                    ...
                    <?php endif; ?>
                        :class="{
                            'listivo-select-v2--active': salaryField.value !== '' || select.open,
                ...
                >
                    ...
                    <template>
                        ...
                        <div
                                ...
                                @click.stop.prevent="salaryField.clear(); select.onClose()"
                        >
    ...
    >
        ...
        >
            ...
            <div class="listivo-range-field">
                ...
                >
                    <div
                            class="listivo-search-form-field listivo-search-form-field--<?php echo esc_attr($lstSearchField->getKey()); ?>-from"
                            slot-scope="salaryField"
                            v-if="salaryField.isVisible"
                    >
                        <lst-select
                ...
                >
                    <div
                            class="listivo-search-form-field listivo-search-form-field--<?php echo esc_attr($lstSearchField->getKey()); ?>-to"
                            slot-scope="salaryField"
                            v-if="salaryField.isVisible"
                    >
                        <lst-select
