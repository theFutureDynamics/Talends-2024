<?php
/* @var \Tangibledesign\Listivo\Widgets\General\HeadingWidget $lstCurrentWidget */
global $lstCurrentWidget;
?>
<div class="listivo-heading listivo-heading--<?php echo esc_attr($lstCurrentWidget->getAlignModifier()); ?> listivo-heading--<?php echo esc_attr($lstCurrentWidget->getDecorationStyle()); ?>">
    ...
    <div class="listivo-heading__main">
        <div class="listivo-heading__text">
            ...
            <?php if ($lstCurrentWidget->isArrowLeftBottomDecorationStyle()) : ?>
            ...
            <?php elseif ($lstCurrentWidget->isArrowRightBottomDecorationStyle()) : ?>
                <div class="listivo-heading__arrow">
            ...
            <?php elseif ($lstCurrentWidget->isTriangleRightDecorationStyle()) : ?>
    ...
    32 195 52 48 14 148 38 171 41 6 0 17 -5 23 -12z'/>
            ...
            <?php elseif ($lstCurrentWidget->isTriangleLeftDecorationStyle()) : ?>
                <div class="listivo-heading__triangle">
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 121.000000 121.000000'
                         preserveAspectRatio='xMidYMid meet'>
                        <g transform='translate(0.000000,121.000000) scale(0.100000,-0.100000)' stroke='none'>
