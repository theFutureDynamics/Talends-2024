<?php
/* @var \Tangibledesign\Listivo\Widgets\General\HeroSearchV2Widget $lstCurrentWidget */
...
<div
    ...
    <?php if (!empty($lstBackgroundImage)): ?>
        style="background-image: url('<?php echo esc_url($lstBackgroundImage->getImageUrl()); ?>');"
    <?php endif; ?>
>
                    ...
                    >
                        <div class="listivo-hero-search-v2__icon">
                            <?php if (!empty($lstCategory['icon'])) : ?>
                                <?php echo tdf_filter($lstCategory['icon']); ?>
                            <?php endif; ?>
                        </div>
