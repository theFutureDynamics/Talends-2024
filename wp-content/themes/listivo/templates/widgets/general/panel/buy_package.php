...
if ($lstModel) {
    $lstPackages = tdf_payment_packages_repository()->getRegularPaymentPackagesForModel($lstCurrentUser, $lstModel);
} else {
    $lstPackages = tdf_payment_packages_repository()->getRegularPaymentPackagesForUser($lstCurrentUser);
}
?>
