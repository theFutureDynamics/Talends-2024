...
$lstPackages = tdf_user_payment_packages_repository()
        ...
        <div class="listivo-panel-section__content listivo-panel-section__content--no-margin-top">
            <template>
                <lst-select-package
                        ...
                        initial-tab="<?php echo esc_attr($lstPackages->isNotEmpty() ? 'my' : 'buy'); ?>"
                >
                    <div slot-scope="props">
                        <?php if ($lstPackages->isNotEmpty()) : ?>
                            <div class="listivo-panel-packages">
                                <?php
                                global $lstPackage;
                                foreach ($lstPackages as $lstPackage) :
