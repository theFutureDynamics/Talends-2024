<?php
/* @var \Tangibledesign\Framework\Models\PanelFields\EmbedPanelField $lstPanelField */
global $lstPanelField;
?>
<lst-embed-model-field
        ...
        td-nonce="<?php echo esc_attr(wp_create_nonce(tdf_prefix() . '_embed_preview')); ?>"
...
>
    ...
    >
        ...
        <div class="listivo-field-group">
            <?php if (!empty($lstPanelField->getPlaceholder())) : ?>
                <label
                        class="listivo-field-group__label"
                        for="<?php echo esc_attr($lstPanelField->getKey()); ?>"
                >
                    <?php echo esc_html($lstPanelField->getPlaceholder()); ?>
                </label>
            <?php endif; ?>
