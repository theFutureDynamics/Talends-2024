<?php
/* @var \Tangibledesign\Framework\Models\PanelFields\NamePanelField $lstPanelField */
global $lstPanelField;
?>
<lst-name-model-field
        class="listivo-panel-form__single-column listivo-field-group"
        :model="modelForm.model"
        :is-required="<?php echo esc_attr(tdf_settings()->nameRequired() ? 'true' : 'false'); ?>"
        :max-length="<?php echo esc_attr(tdf_settings()->getNameLength()); ?>"
>
    <div
            slot-scope="field"
            class="listivo-panel-form__single-column listivo-field-group <?php echo esc_attr($lstPanelField->getKey()); ?>"
    >
        <label
        ...
        >
            ...
            <?php if (!empty(tdf_settings()->getNameHint())): ?>
                <div class="listivo-field-hint">
                    ...
                    <div class="listivo-field-hint__text">
                        <?php echo esc_html(tdf_settings()->getNameHint()); ?>
                    </div>
                </div>
            <?php endif; ?>
        </label>
        ...
        <div class="listivo-field-group__field">
            ...
            >
                <input
                        ...
                        name="<?php echo esc_attr($lstPanelField->getKey()); ?>"
                        type="text"
                ...
                <template>
                    <div class="listivo-input-v2__error">
                        <div :class="{'listivo-field-error': modelForm.showErrors && field.hasError, 'listivo-submit-field-active': field.value !== ''}">
                            ...
                            <span v-if="field.value !== ''">
                                <?php echo esc_html(tdf_string('max_length')).' '.tdf_settings()->getNameLength(); ?>
                            </span>
                        </div>
                    </div>
