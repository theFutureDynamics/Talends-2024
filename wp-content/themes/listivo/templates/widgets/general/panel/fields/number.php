<?php
/* @var \Tangibledesign\Framework\Models\PanelFields\NumberPanelField $lstPanelField */
global $lstPanelField;
/* @var \Tangibledesign\Framework\Models\Field\NumberField $lstNumberField */
$lstNumberField = $lstPanelField->getField();
?>
<lst-number-model-field
    ...
    >
        ...
        <div class="listivo-field-group__field">
            ...
            >
                ...
                <?php if (!empty($lstNumberField->getTextAfterValue())) : ?>
                    <div class="listivo-input-v2__postfix">
                        <?php echo esc_html($lstNumberField->getTextAfterValue()); ?>
                    </div>
                <?php endif; ?>
