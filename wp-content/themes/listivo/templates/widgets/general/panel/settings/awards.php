...
$awards = $lstCurrentWidget->getUserSettings();
...
>
    <div
            slot-scope="props"
            class="listivo-panel-accordions__item listivo-panel-accordion"
            :class="{'listivo-panel-accordion--active': accordions.open === 'awards'}"
    >
        <div
                class="listivo-panel-accordion__top"
                @click.prevent="accordions.onOpen('awards')"
        >
            <h3 class="listivo-panel-accordion__label">
                <?php echo esc_html(tdf_string('awards')); ?>
            </h3>
        ...
        <form @submit.prevent="props.onSave">
            <div class="listivo-panel-accordion__content-wrapper listivo-panel-accordion__content-wrapper--awards">
                <div class="listivo-panel-accordion__content listivo-panel-user-settings">
                    <div>
                        <div style="text-align: center;">
                            <img src="<?php echo esc_url($image_url); ?>" alt="Award Image" style="max-width: 100%; height: auto; display: inline-block;">
                        </div>
                        <div >
                            <label
                                    ...
                                    for="listivo-name"
                            >
                                <?php echo esc_html(tdf_string('award_title')); ?> - 1
                            </label>
                            ...
                            <div class="listivo-field-group__field">
                                ...
                                >
                                    <input
                                            id="listivo-award_title1"
                                            type="text"
                                            :value="props.award_title1"
                                            @input="props.setAwardTitle1($event.target.value)"
                                            placeholder="<?php echo esc_attr(tdf_string('award_title')); ?>"
                                    >
                    ...
                    <div style="padding-top:20px">
                        ...
                        <div >
                            <label
                                    ...
                                    for="listivo-name"
                            >
                                <?php echo esc_html(tdf_string('award_title')); ?> - 2
                            </label>
                            ...
                            <div class="listivo-field-group__field">
                                <div
                                        class="listivo-input-v2"
                                        :class="{
                                            'listivo-input-v2--error': props.showErrors && (!props.errors.award_title.required || !props.errors.degree_title.minLength),
                                        }"
                                >
                                    <input
                                            id="props.award_title2"
                                            type="text"
                                            :value="props.award_title2"
                                            @input="props.setAwardTitle2($event.target.value)"
                                            placeholder="<?php echo esc_attr(tdf_string('award_title')); ?>"
                                    >

                                    <template>
                                        <div
                                                v-if="props.showErrors && (!props.errors.award_title2.required || !props.errors.award_title2.minLength)"
                                                class="listivo-input-v2__error"
                                        >
                                            <div class="listivo-field-error">
                                                <div class="listivo-field-error__icon">
                    ...
                    <div style="text-align: center;">
                        ...
                        <label
                                ...
                                for="listivo-name"
                        >
                            <?php echo esc_html(tdf_string('award_title')); ?> - 3
                        </label>
                        ...
                        <div class="listivo-field-group__field">
                            ...
                            >
                                <input
                                        id="listivo-award_title3"
                                        type="text"
                                        :value="props.award_title3"
                                        @input="props.setAwardTitle3($event.target.value)"
                                        placeholder="<?php echo esc_attr(tdf_string('award_title')); ?>"
                                >
