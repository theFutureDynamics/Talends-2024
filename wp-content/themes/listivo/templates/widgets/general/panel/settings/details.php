                    ...
                    <?php endif; ?>
                        ...
                        <?php if ($account_type == "business"): ?>
                            ...
                            <div class="listivo-field-group__field">
                                ...
                                <!-- Add Skill Button -->
                                <a href="javascript:;" style="margin-top:20px;margin-bottom:20px"  @click.prevent="props.addSkill"  class="listivo-simple-button listivo-simple-button--background-primary-1">
