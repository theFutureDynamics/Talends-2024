...
>
    <div
            slot-scope="props"
            class="listivo-panel-accordions__item listivo-panel-accordion"
            :class="{'listivo-panel-accordion--active': accordions.open === 'expertise'}"
    >
        <div
                class="listivo-panel-accordion__top"
                @click.prevent="accordions.onOpen('expertise')"
        >
            <h3 class="listivo-panel-accordion__label">
                <?php echo esc_html(tdf_string('expertise')); ?>
            </h3>
        ...
        <form @submit.prevent="props.onSave">
            <div class="listivo-panel-accordion__content-wrapper listivo-panel-accordion__content-wrapper--expertise">
                ...
                <div class="listivo-panel-user-settings__field listivo-field-group">
                        <label
                                ...
                                for="listivo-name"
                        >
                            <?php echo esc_html(tdf_string('expertise_title')); ?>
                        </label>
                        ...
                        <div class="listivo-field-group__field">
                            ...
                            >
                                <input
                                        id="listivo-expertise_title"
                                        type="text"
                                        :value="props.expertise_title"
                                        @input="props.setExpertiseTitle($event.target.value)"
                                        placeholder="<?php echo esc_attr(tdf_string('expertise_title')); ?>"
                                >

                                <template>
                                    <div
                                            v-if="props.showErrors && (!props.errors.expertise_title.required || !props.errors.expertise_title.minLength)"
                                    ...
                                    >
                                        <div class="listivo-field-error">
                                            ...
                                            <div v-if="!props.errors.expertise_title.required">
                            ...
                            <template>
                                    ...
                                    >
                                        <div class="listivo-field-error">
                                            ...
                                            <div v-if="!props.errors.expertise_description.required">
                                                <?php echo esc_html(tdf_string('field_is_required')); ?>
                                            </div>
                                        </div>
                                    </div>
