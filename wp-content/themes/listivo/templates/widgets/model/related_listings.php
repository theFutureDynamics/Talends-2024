...
/* @var RelatedListingsWidget $lstCurrentWidget */
global $lstCurrentWidget;

$lstRelatedListings = $lstCurrentWidget->getListings();
if ($lstRelatedListings->isEmpty()) {
    return;
}
?>
            ...
            <div class="listivo-listing-carousel__top">
                ...
                <div class="listivo-listing-carousel__right">
                    <div class="listivo-listing-carousel__button">
                        ...
                        >
                            <?php echo esc_html(tdf_string('start_new_search')); ?>
                        </a>
                    </div>
