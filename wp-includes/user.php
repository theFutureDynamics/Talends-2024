...
function wp_insert_user( $userdata ) {
	...
	$compacted = compact( 'user_pass', 'user_nicename', 'user_email', 'user_url', 'user_registered', 'user_activation_key', 'display_name','type' );
...
if ( isset($_POST['user']['agency_expertises']) && is_array($_POST['user']['agency_expertises']) ) {
